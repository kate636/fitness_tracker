...
df_train["lable"].value_counts().plot(
...
(
    ...
    X_train[feature_set4], y_train, X_test[feature_set4], gridsearch=True
)
...
X_train = participant_df[participant_df["participant"] != "A"].drop("lable", axis=1)
y_train = participant_df[participant_df["participant"] != "A"]["lable"]

X_test = participant_df[participant_df["participant"] == "A"].drop("lable", axis=1)
y_test = participant_df[participant_df["participant"] == "A"]["lable"]
